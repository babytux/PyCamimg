...
import plugins
import gettext
camimgpluginName="SepiaToneOperation"
...
class camimgplugin(ICamimgPlugin):
    ...
    def getName(self):
        ...
        return gettext.translation(camimgpluginName, __LOCALE_FOLDER__, 
                                   languages=[__LANGKEY__], fallback = True).gettext("Sepia Toning Operation")    
    ...
    def initialize(self):
        ...
        from SepiaToneOperation.Operation import SepiaTone
        gettext.bindtextdomain(camimgpluginName, __LOCALE_FOLDER__)
        Operations.addOperation(Operation.OPERATION, SepiaTone)